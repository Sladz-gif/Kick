     ...
     const uploadImage = async (file) => {
      ...
      return (
          <div style={{ padding: '20px' }}>
              <Typography variant="h4" style={{ color: '#3D1401', marginBottom: '20px' }}>Manage Highlights of the Week</Typography>
              ...
              <form onSubmit={handleSubmit} style={{ marginBottom: '40px' }}>
               ...
               {/* Display existing products specific to Highlights */}
               <Typography variant="h5" style={{ color: '#3D1401', marginBottom: '20px' }}>Existing Products in Highlights of the Week</Typography>
               <Grid container spacing={2}>
                   {(products || []).filter(product => product.secondaryCategory === 'Highlights').map(product => (
