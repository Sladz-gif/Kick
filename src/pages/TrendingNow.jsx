...
const TrendingNow = () => {
    ...
    return (
        <div style={{ padding: '20px' }}>
            <Typography variant="h4" style={{ color: '#3D1401', marginBottom: '20px' }}>Manage Trending Now</Typography>
            ...
            <form onSubmit={handleSubmit} style={{ marginBottom: '40px' }}>
              ...
              <Typography variant="h5" style={{ color: '#3D1401', marginBottom: '20px' }}>Existing Products in Trending Now</Typography>
              <Grid container spacing={2}>
                  {(products || []).filter(product => product.secondaryCategory === 'Trending Now').map(product => (
